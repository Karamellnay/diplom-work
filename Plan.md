...
База данных содержит в себе переданные данные в виде таблицы.
...
### В датахелпере будут использованы методы генерации номера карты (12 цифр), месяца (две цифры месяца), года (две последние цифры года, не ранее 2024), владельца (фамилия и имя на латинице), кода cvc (три цифры).
